...
if __name__ == '__main__':
    ...
    parser.add_argument("--image_path", type=str,   default='/home/yons/data3/wwj/data/cGAN_data/training/', help="path to load training image")
    parser.add_argument("--mask_path",  type=str,   default='/home/yons/data3/wwj/data/cGAN_data/training/', help="path to load training masks")
    parser.add_argument("--val_image",  type=str,   default="/home/yons/data3/wwj/data/cGAN_data/val_org/",  help="path to load validation image")
    parser.add_argument("--val_mask",   type=str,   default="/home/yons/data3/wwj/data/cGAN_data/val_gt/",   help="path to load validation masks")
    parser.add_argument("--bboxfile",   type=str,   default="/home/yons/data3/wwj/iaanet/cGAN_data/train_0_box_gt.csv", help="path to bounding boxes ground truth")
    parser.add_argument("--save_path",  type=str,   default='/home/yons/data3/wwj/iaanet/outputs/demo1', help="path to save model")
    ...
    parser.add_argument("--max_det_num",type=int,   default=3, help="Maximum number of region boxes proposed by detect head")##
    parser.add_argument("--hidden_dim", type=int,   default=256, help="卷积最后输出通道数 hidden_dim of transformer")##
    ...
    parser.add_argument('--rpn_pretrained', type=str, default=None, help='"/home/yons/data3/wwj/iaanet/pretrained/rpn.pt" load pretrained rpn weights')
    parser.add_argument("--expand",     type=int, default=8, help="The additonal length of expanded local region for semantic generator")
    parser.add_argument('--fast',       default=True,  help="action='store_true',fast inference")
    ...
    for epoch in range(args.epochs):
        ...
        mloss = np.zeros(5, dtype=np.float64)
        ...
        #val 
        Model.eval()
        F1 = test1(args.val_image, args.val_mask, Model, device=device, conf_thres=args.conf_thres, iou_thres=args.iou_thres, expand=args.expand, topk=args.topk, fast=args.fast)
        F1_list.append(F1)
        if F1 > Best_F1:
            Best_F1 = F1
